...
// Strapi client
import { getCurrentCourses, getPastCourses, getSupervisions } from "@/lib/strapi";
...
export default async function TeachingPage() {
  const [currentCoursesData, pastCoursesData, supervisionsData] = await Promise.all([
    getCurrentCourses(),
    getPastCourses(),
    getSupervisions(),
  ]);

  const currentCourses = currentCoursesData ?? staticCurrentCourses;
  const pastCourses = pastCoursesData ?? staticPastCourses;
  const supervisions = supervisionsData ?? staticSupervisions;
